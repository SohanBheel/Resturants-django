...
from . models import restaurant,fooditem,MyUser,table,bookingrecord,foodorder,restaurantcategories,Contact
...
def help(request):
    return redirect(f"https://wa.me/+918239239249?text=I want Some Help")
